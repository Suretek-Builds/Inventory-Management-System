<template>
  <nav class="navbar top-navbaar-design navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
      <router-link to="/" class="navbar-brand">Inventory Management</router-link>
